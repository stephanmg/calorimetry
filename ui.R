...
sidebar_content <- sidebarPanel(
   ...
   sliderInput("exclusion_start", "Exclude hours from start of measurements", 0, 24, 2, step=1),
   sliderInput("exclusion_end", "Exclude hours from end of measurements", 0, 24, 2, step=1),
