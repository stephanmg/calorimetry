...
sidebar_content <- sidebarPanel(
 ...
 # ),verbatimTextOutput(outputId="res1"),
   ...
   selectInput("plot_type", "Type:", c("CompareHeatProductionFormulas", "CaloricEquivalentOverTime", "DayNightActivity", "StackedBarPlotForRMRandNonRMR", "ANCOVA", "Histogram", "RAW")),
