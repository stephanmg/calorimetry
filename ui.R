...
page_for_visualization <- fluidPage(
   ...
   conditionalPanel(condition = "input.plot_type == 'RawMeasurement'", checkboxInput("sg_filter", "Apply Savitzky-Golay Filter", value = FALSE)),
   conditionalPanel(condition = "input.sg_filter == true", numericInput("sg_filter_p", "p", min=1, max = 3, value = 2, step = 1)),
   conditionalPanel(condition = "input.sg_filter == true", numericInput("sg_filter_n", "n", min=1, max = 11, value = 5, step = 1)),
