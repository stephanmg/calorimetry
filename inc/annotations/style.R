	...
	return(
		tagList(
			...
			conditionalPanel("input.stylize_plot_axes == true && (input.stylize_plot_axes_components.indexOf('Ticks') > -1)",
				...
				checkboxInput("stylize_plot_axes_ticks_disable_ticks", "Enable manual ticks"),
				fluidRow(
					column(6,
						h5("x-axis ticks"),
						numericInput("stylize_plot_axes_x_axis_tickfont_size", "Font size for tick labels (in)", min=1, max=32, step=1, value=12),
						numericInput("stylize_plot_axes_ticks_x_ticks", "Increase or decrease number of ticks", min=1, value = 10, max=1000, step=1),
					...
					column(6,
						...
						numericInput("stylize_plot_axes_ticks_y_ticks", "Increase or decrease number of ticks", min=1, value = 10, max=1000, step=1),
