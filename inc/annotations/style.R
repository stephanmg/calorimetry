	...
	return(
		tagList(
			...
			conditionalPanel("input.stylize_plot_axes == true && (input.stylize_plot_axes_components.indexOf('Ticks') > -1)",
				...
				checkboxInput("stylize_plot_axes_ticks_disable_ticks", "Specify ticks manually"),
				fluidRow(
					column(6,
						h5("x-axis ticks"),
						numericInput("stylize_plot_axes_x_axis_tickfont_size", "Font size for tick labels (in)", min=1, max=32, step=1, value=12),
						conditionalPanel("input.stylize_plot_axes_ticks_disable_ticks != true", numericInput("stylize_plot_axes_ticks_x_ticks", "Number of ticks", min=1, value = 10, max=1000, step=1)),
						conditionalPanel("input.stylize_plot_axes_ticks_disable_ticks == true", numericInput("stylize_plot_axes_ticks_x_ticks", "Specify pattern", min=1, value = 10, max=1000, step=1)),
						numericInput("stylize_plot_axes_ticks_x_ticks_length", "Length of ticks", min=5, value = 5, max=20, step=1),
					...
					column(6,
						...
						conditionalPanel("input.stylize_plot_axes_ticks_disable_ticks != true", numericInput("stylize_plot_axes_ticks_y_ticks", "Number of ticks", min=1, value = 10, max=1000, step=1)),
						conditionalPanel("input.stylize_plot_axes_ticks_disable_ticks == true", numericInput("stylize_plot_axes_ticks_y_ticks", "Specify pattern", min=1, value = 10, max=1000, step=1)),
						numericInput("stylize_plot_axes_ticks_x_ticks_length", "Length of ticks", min=1, value = 5, max=20, step=1),
